...
=============
    ...
    This package contains cputil Ver 1.1.1.
    ...
    cputil can be use on any platform supported by .NET Core 3.1 including:
      - Windows x86 and x64                             ... cputil-win-x86_v111.zip / cputil-win-x64_v111.zip
      - Linux x64                                       ... cputil-linux-x64_v111.tar.gz
      - Apple Mac OS (OSX) x64 (Except 10.15 or later)  ... cputil-osx-x64_v111.tar.gz
      - Apple Mac OS (OSX) x64 (10.15 or later)         ... cputil-osx-x64_v111.zip
