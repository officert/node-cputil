    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                cmd = "".concat(printerType || StarPrinterType.THERMAL_3, " scale-to-fit decode ").concat(outputFormat, " \"").concat(tmpFilePath, "\" \"").concat(outputFilePath, "\"");
...
function execCputil(command) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    child_process.execFile(command, function (error, stdout, stderr) {
                        if (error) {
                            return reject(error);
                        }
                        if (stderr) {
